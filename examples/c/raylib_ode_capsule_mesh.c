...
int main(void) {
    ...
    dBodySetPosition(capsuleBody, 2.0f, 2.5f, 0.0f); // Position capsule to the side

    // Store initial capsule position for reset
    Vector3 initialCube1Pos = (Vector3){ 0.0f, 1.5f, 0.0f };
    Vector3 initialCube2Pos = (Vector3){ 0.0f, 3.5f, 0.0f }; // Adjusted to stack cubes
    Vector3 initialCapsulePos = (Vector3){ 2.0f, 2.5f, 0.0f };
